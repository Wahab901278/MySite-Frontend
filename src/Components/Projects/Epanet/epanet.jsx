        ...
        <div className="left-content">
          <div className="left-content-inner">
            ...
            <div className="description">
              <p>
                Created resilient water networks on Epanet integrated with
                Python through libraries, ensuring redundancy, robust
                infrastructure, real time monitoring and cost optimization.
                Analyzed and optimized water distribution networks to ensure
